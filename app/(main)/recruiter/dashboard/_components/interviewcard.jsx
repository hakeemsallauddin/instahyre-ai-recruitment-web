...
function InterviewCard({ interview, viewDetail = false, onDelete }) {
  ...
  const getInterviewUrl = () => {
    const baseUrl = process.env.NEXT_PUBLIC_HOST_URL.replace(/\/$/, "") + '/interview';
  ...
  const onSend = () => {
    ...
    window.location.href = `mailto:sallauddinab@gmail.com?subject=AI Recruiter Interview Link&body=Hi, I would like to schedule an interview with you. Please find the link below:\n\n${interviewUrl}`;
      ...
      <AlertDialog open={showDeleteAlert} onOpenChange={setShowDeleteAlert}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            {/* Moved the <ul> outside AlertDialogDescription */}
